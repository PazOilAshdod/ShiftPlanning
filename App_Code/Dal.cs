...
public class Dal
{
    ...
    public static string _dbHarmonyConnectionString = System.Web.Configuration.WebConfigurationManager.ConnectionStrings["dbDataHarmonyConnectionString"].ToString();
    ...
    /// <param name="sqlCommand"></param>
    /// <returns></returns>
    public static DataTable Harmony_GetDataTable(string sqlCommand)
    {


        using (SqlConnection myConnection = new SqlConnection(_dbHarmonyConnectionString))
        {
            using (SqlCommand myCommand = new SqlCommand(sqlCommand, myConnection))
            {
                myConnection.Open();
